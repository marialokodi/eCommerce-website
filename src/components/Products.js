...
const Products = (props) => {
  ...
  const ShowProducts = () => {
    return (
      <div>
        <div className="buttons d-flex justify-content-center mb-4 pb-3">
          <button
          ...
          <button
            className="btn btn-outline-dark me-2"
            onClick={() => FilterProduct("ring")}
          >
            Ring
          </button>
          <button
            className="btn btn-outline-dark me-2"
            onClick={() => FilterProduct("necklance")}
          >
            Necklace
          </button>
          <button
            className="btn btn-outline-dark me-2"
            onClick={() => FilterProduct("bracelet")}
          >
            Bracelet
          </button>
          <button
            className="btn btn-outline-dark me-2"
            onClick={() => FilterProduct("earring")}
          >
            Earring
          </button>
        </div>
            ...
            .map((product) => {
              return (
                ...
                >
                  ...
                  <Card.Body className="d-flex justify-content-lg-around d-flex align-items-center mb-4 pb-2">
                    <Button
